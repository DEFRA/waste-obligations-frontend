...
describe('#cookiesController', () => {
  ...
  test('Should render essential cookie details from translations', async () => {
    ...
    expect(payload).toContain(cookiesContent.analyticsCookiesHeading)
    ...
    expect(payload).toContain(cookiesContent.policy.purpose)
    expect(payload).toContain(sessionCookieTtl)
    expect(payload).toContain(cookiesContent.oauthState.expires)
    expect(payload).toContain(cookiesContent.settings.legend)
  ...
  test('renders the GOV.UK analytics cookies section with GA4 cookies and settings', async () => {
    ...
    expect(payload).toContain('_ga_&lt;measurement-id&gt;')
  ...
  test('shows the cookie banner until the user confirms a choice', async () => {
    ...
    expect(result).toEqual(expect.stringContaining('js-cookies-button-accept'))
    expect(result).toEqual(
    ...
    expect(result).not.toEqual(expect.stringContaining('googletagmanager.com'))
  ...
  test('does not expire GA cookies on first visit', async () => {
