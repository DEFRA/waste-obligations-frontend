...
describe('compliance routes', () => {
  ...
  test('GET /producer/{organisationId}/compliance/certificate renders page with year', async () => {
  ...
  test('prefixes the producer certificate view-submission link for a reverse proxy', async () => {
    ...
    expect(result).toEqual(
      expect.stringContaining(
        `href="/manage-recycling-obligations/producer/${organisationId}/compliance/certificate/${complianceDeclarationId}/success"`
      )
    )
    expect(getNonPrefixedServiceLinkHrefs(result, forwardedPrefix)).toEqual([])
  })

  test('GET /producer/{organisationId}/compliance/certificate renders default regulator email', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
  ...
  test('GET /cso/{schemeId}/compliance/statement renders page with year', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
  ...
  test('GET /cso/{schemeId}/compliance/statement defaults regulator email to England', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
  ...
  test('GET /producer/{organisationId}/compliance/certificate uses businessCountry from organisation API', async () => {
  ...
  test('GET /producer/{organisationId}/compliance/certificate loads organisation details', async () => {
  ...
  test('GET /producer/{organisationId}/compliance/certificate returns 500 when organisation lookup fails', async () => {
  ...
  test('GET /producer/{organisationId}/compliance/certificate returns 404 when organisation is not found', async () => {
  ...
  test('GET /producer/{organisationId}/compliance/certificate/{complianceDeclarationId}/success returns 404 when user lacks organisation access', async () => {
    await expectForbiddenForUnenrolledAccess({
      method: 'GET',
      url: `/producer/${unauthorisedOrganisationId}/compliance/certificate/6830b9d4c7e21f5a8d3e64b2/success`
    })
  })

  test('POST /producer/{organisationId}/compliance/certificate/submit returns 403 without CSRF token when user lacks organisation access', async () => {
    await expectForbiddenForUnenrolledAccess(
      {
        method: 'POST',
        url: `/producer/${unauthorisedOrganisationId}/compliance/certificate/submit?year=2026`,
  ...
  describe('basic user permissions', () => {
    ...
    test('GET /producer/{organisationId}/compliance/certificate returns 403 for basic users', async () => {
      const { result, statusCode } = await injectAuthed(
        server,
        {
          method: 'GET',
    ...
    test('GET /producer/{organisationId}/compliance/certificate/submit returns 403 for basic users', async () => {
      const { result, statusCode } = await injectAuthed(
        server,
        {
          method: 'GET',
    ...
    test('GET /producer/{organisationId}/compliance/certificate/{complianceDeclarationId} allows basic users to view submitted CSoC', async () => {
      const { statusCode } = await injectAuthed(
        server,
        {
          method: 'GET',
          url: `/producer/${organisationId}/compliance/certificate/6830b9d4c7e21f5a8d3e64b2`
        },
        basicUserAuthHeaders
      )
  ...
  test('GET /producer/{organisationId}/compliance/certificate returns 400 when organisationId is invalid', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
  ...
  test('GET /producer/{organisationId}/compliance/certificate returns 400 when year is missing', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
        url: `/producer/${organisationId}/compliance/certificate`
      },
      authHeaders
    )
  ...
  test('GET /cso/{schemeId}/compliance/statement returns 400 when year is out of range', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
        url: `/cso/${schemeId}/compliance/statement?year=1900`
      },
      authHeaders
    )
  ...
  test('GET /producer/{organisationId}/compliance/certificate returns bad request when lang=cy', async () => {
    const { result, statusCode } = await injectAuthed(
      server,
      {
        method: 'GET',
        url: `/producer/${organisationId}/compliance/certificate?lang=cy`
      },
      authHeaders
    )
  ...
  test('GET /producer/{organisationId}/compliance/certificate/submit back link returns to previous page', async () => {
  ...
  test('POST /producer/{organisationId}/compliance/certificate/submit returns 403 without CSRF token', async () => {
    const { statusCode } = await injectAuthed(
      server,
      {
        method: 'POST',
  ...
  test('POST /producer/{organisationId}/compliance/certificate/submit redirects to certificate success', async () => {
    ...
    expect(headers.location).toBe(
      `/producer/${organisationId}/compliance/certificate/6830b9d4c7e21f5a8d3e64b2/success`
    )
    expect(
      wasteObligationsApiMock.createComplianceDeclaration
    ).toHaveBeenCalled()
  ...
  test('GET /producer/{organisationId}/compliance/certificate/{complianceDeclarationId} renders submitted certificate', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    const { result, statusCode } = await injectAuthed(
      server,
      {
  ...
  test('GET /producer/{organisationId}/compliance/certificate/{complianceDeclarationId}/success shows confirmation from compliance declaration API', async () => {
    ...
    const { result, statusCode } = await injectAuthed(
      ...
      {
        method: 'GET',
        url: `/producer/${organisationId}/compliance/certificate/${complianceDeclarationId}/success`
      },
      authHeaders
    )
    ...
    expect(result).toEqual(
      expect.stringContaining(
        `/producer/${organisationId}/compliance/certificate/${complianceDeclarationId}`
      )
    )
    expect(result).toEqual(
  ...
  test('GET /producer/{organisationId}/compliance/certificate/{complianceDeclarationId}/success shows not met obligations text when declaration is NotMet', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    const { load } = await import('cheerio')
  ...
  test('POST /producer/{organisationId}/compliance/certificate/submit uses not_met when obligations API returns NotMet', async () => {
    redisStore.set(
  ...
  test('GET /producer/{organisationId}/compliance/certificate/submit redirects when declaration already submitted', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    wasteObligationsApiMock.getComplianceDeclarations.mockResolvedValue({
      complianceDeclarations: [
        buildComplianceDeclaration(organisationId, 2026, {
  ...
  test.each([
    ...
    'POST /producer/{organisationId}/compliance/certificate/submit re-renders page when fullName is $name',
  ...
  test('POST /producer/{organisationId}/compliance/certificate/submit renders service error when obligations API is unavailable', async () => {
    const { load } = await import('cheerio')
  ...
  test('GET /cso/{schemeId}/compliance/statement shows continue when no submission exists', async () => {
    wasteObligationsApiMock.getComplianceDeclarations.mockResolvedValueOnce({
      complianceDeclarations: []
    })
  ...
  test('GET /cso/{schemeId}/compliance/statement/submit renders submit page with year', async () => {
    wasteObligationsApiMock.getComplianceDeclarations.mockResolvedValueOnce({
      complianceDeclarations: []
    })
  ...
  test('GET /cso/{schemeId}/compliance/statement/submit redirects when declaration already submitted', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    wasteObligationsApiMock.getComplianceDeclarations.mockResolvedValue({
      complianceDeclarations: [
    ...
    expect(statusCode).toBe(302)
    expect(headers.location).toBe(
      `/cso/${schemeId}/compliance/statement/${complianceDeclarationId}`
    )
  })
  ...
  test.each([
    ...
    'GET /cso/{schemeId}/compliance/statement/submit maps regulator details for $businessCountry',
  ...
  test('POST /cso/{schemeId}/compliance/statement/submit returns 403 without CSRF token when user lacks scheme access', async () => {
    await expectForbiddenForUnenrolledAccess(
      {
        method: 'POST',
        url: `/cso/${unauthorisedSchemeId}/compliance/statement/submit?year=2026`,
  ...
  test('POST /cso/{schemeId}/compliance/statement/submit redirects to success page', async () => {
    ...
    expect(statusCode).toBe(302)
    expect(headers.location).toBe(
      `/cso/${schemeId}/compliance/statement/6830b9d4c7e21f5a8d3e64b2/success`
    )
    expect(
      wasteObligationsApiMock.createComplianceDeclaration
  ...
  test('GET /cso/{schemeId}/compliance/statement/{complianceDeclarationId}/success renders success page', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    ...
    const { result, statusCode } = await injectAuthed(
      ...
      {
        method: 'GET',
        url: `/cso/${schemeId}/compliance/statement/${complianceDeclarationId}/success`
      },
      authHeaders
    )
  ...
  test('GET /cso/{schemeId}/compliance/statement/{complianceDeclarationId} renders submitted statement', async () => {
    const complianceDeclarationId = '6830b9d4c7e21f5a8d3e64b2'
    ...
    const { result, statusCode } = await injectAuthed(
      ...
      {
        method: 'GET',
        url: `/cso/${schemeId}/compliance/statement/${complianceDeclarationId}`
      },
      authHeaders
    )
