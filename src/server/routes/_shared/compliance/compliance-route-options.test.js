...
import { organisation } from '#/server/common/routes/middleware/organisation.js'
import { certificateRoutes } from '#/server/routes/producer/compliance/certificate/controller.js'
import { certificateSubmitRoutes } from '#/server/routes/producer/compliance/certificate-submit/controller.js'
import { certificateSuccessRoutes } from '#/server/routes/producer/compliance/certificate-success/controller.js'
import { certificateViewRoutes } from '#/server/routes/producer/compliance/certificate-view/controller.js'
import { statementRoutes } from '#/server/routes/cso/compliance/statement/controller.js'
import { statementSubmitRoutes } from '#/server/routes/cso/compliance/statement-submit/controller.js'
import { statementSuccessRoutes } from '#/server/routes/cso/compliance/statement-success/controller.js'
import { statementViewRoutes } from '#/server/routes/cso/compliance/statement-view/controller.js'
