...
describe('statementSuccessController', () => {
  test('renders success page with declaration and logged in user details', async () => {
    ...
    expect(h.view).toHaveBeenCalledWith(
      'cso/compliance/statement-success/index',
      expect.objectContaining({
        ...
        statementViewHref: `/cso/a1b2c3d4-e5f6-4789-abcd-ef1234567890/compliance/statement/${complianceDeclarationId}`
      })
    )
  ...
  test('prefixes the statement view link for a reverse proxy', async () => {
    ...
    expect(model.statementViewHref).toBe(
      `/manage-recycling-obligations/cso/${request.params.schemeId}/compliance/statement/${complianceDeclarationId}`
    )
  })
