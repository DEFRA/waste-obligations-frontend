...
import { buildStatementComplianceDeclarationPayload } from '#/server/routes/_shared/compliance/compliance-submit/api-payload.js'
import { createSubmitCachePreHandler } from '#/server/routes/_shared/compliance/compliance-submit/cache-pre-handler.js'
import { mergeFormErrors } from '#/server/routes/_shared/compliance/compliance-submit/form-errors.js'
...
import { getRegulation43FormErrors } from '#/server/routes/_shared/compliance/regulation43-validation.js'
...
export const statementSubmitController = {
  method: 'GET',
  path: '/cso/{schemeId}/compliance/statement/submit',
  options: {
    ...csoComplianceRouteOptions,
  ...
  async handler(request, h) {
    ...
    return h.view(
      'cso/compliance/statement-submit/index',
